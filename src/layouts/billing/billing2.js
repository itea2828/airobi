...
//     try {
//         setLoading(true)
//         const response = await axios.get(`http://185.125.90.121/api/v1/subcategories/list/`, config)
//         .then(res => {
//             const o = res.data;
...
//   UPDATE 
  ...
  const putProduct = async (e) => {
    ...
    try {
        ...
        const response = await axios.put(`http://185.125.90.121/api/v1/products/${params.id}/`, formData, config)
        .then(res => {
