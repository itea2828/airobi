...
function CategoryDetail() {
  ...
  const getOrder = async () => {
    ...
    try {
        setLoading(true)
        const response = await axios.get(`http://185.125.90.121/api/v1/categories/${params.id}/`, config)
        .then(res => {
            const o = res.data;
...
//   UPDATE 
  ...
  const putProduct = async (e) => {
    ...
    try {
        ...
        const response = await axios.put(`http://185.125.90.121/api/v1/categories/${params.id}/`, formData, config)
        .then(res => {
    ...
    const deleteProduct = async () => {
        try {
            ...
            setLoading(true)
            // console.log(`user`, user)
            const response = await axios.delete(`http://185.125.90.121/api/v1/categories/${params.id}/`, config)
            .then(res => {
                // const productUpdated = res.data;
