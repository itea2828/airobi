...
function ProductCrud() {
  ...
  const getOrder = async () => {
    ...
    try {
        setLoading(true)
        const response = await axios.get(`http://185.125.90.121/api/v1/products/${params.id}/`, config)
        .then(res => {
            const o = res.data;
  ...
  // Товары /////// //////////////////////
    ...
    const putImage = async () => {
        try {
            ...
            const response = await axios.put(`http://185.125.90.121/api/v1/products/${params.id}/put/image/`, formData, config)
            .then(res => {
                const p = res.data;
                console.log(`p =`, p)
    ...
    const putImage2 = async () => {
        try {
            ...
            setLoading(true)
            // console.log(`user`, user)
            const response = await axios.put(`http://185.125.90.121/api/v1/products/${params.id}/put/image2/`, formData, config)
            .then(res => {
                const p = res.data;
                console.log(`p =`, p)
    ...
    const putImage3 = async () => {
        try {
            ...
            setLoading(true)
            // console.log(`user`, user)
            const response = await axios.put(`http://185.125.90.121/api/v1/products/${params.id}/put/image3/`, formData, config)
            .then(res => {
                const p = res.data;
                console.log(`p =`, p)
    ...
    const putImage4 = async () => {
        try {
            ...
            setLoading(true)
            // console.log(`user`, user)
            const response = await axios.put(`http://185.125.90.121/api/v1/products/${params.id}/put/image4/`, formData, config)
            .then(res => {
                const p = res.data;
                console.log(`p =`, p)
    ...
    const putProduct = async (e) => {
        e.preventDefault()
        try {
            if(title === '' || price === '' || category === undefined || subcategory === undefined  || category === null || subcategory === null ) {
            ...
            setLoading(true)
            // console.log(`user`, user)
            const response = await axios.put(`http://185.125.90.121/api/v1/products/${params.id}/put/`, formData, config)
            .then(res => {
    ...
    const deleteProduct = async () => {
        try {
            ...
            setLoading(true)
            // console.log(`user`, user)
            const response = await axios.delete(`http://185.125.90.121/api/v1/products/${params.id}/`, config)
            .then(res => {
                // const productUpdated = res.data;
